...
while (True):
    ...
    # if sensor1_distance > threshold and sensor2_distance > threshold:
        # print("----------", sensor1_distance, " , ", sensor2_distance)
#    print(sensor1_distance, " ", type(sensor1_distance))
 #   print(sensor2_distance, " ", type(sensor2_distance))
    #print({"distance 1: ":sensor1.read_distance(True)/100})
    #print({"distance 2: ":sensor2.read_distance(True)/100})
    #time.sleep(0.025)
